...
def blrObjFunction(params, *args):
    ...
    Output: 
        ...
        error_grad: the vector of size (D+1) x 1 representing the gradient of
                    error function
    """
    #initialWeights, train_data, labeli = args
    
    #print initialWeights.shape #716x1
    #print labeli.shape #50000x1
    #print train_data.shape #50000 x 715
    ...
    #logoneminusi = np.log(np.subtract(1, y))
    ...
    #a = np.array([[0,1,2,5],[0,5,2,8], [0,5,2,1]])
    #b = np.ones((3,1))
    #print a
    #print b
    ...
    #p(t|w)
    #wTranspose = np.transpose(initialWeights)
    #wTransposeX = np.multiply(wTranspose, train_data)
    #sigmoidOfwTransposeX = sigmoid(wTransposeX)
    #
    #for p(t|w)
    
   #likelihoodFunc = np.multiply(
...
print "train_data", np.sum(train_data)
